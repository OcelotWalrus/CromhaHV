...
faction-tyrian =
   ...
   .description = Tyrian Federation
    ...
    it, all terraformed by the Quargs, making them huge "balls of ocean".

    Faction Variations:
        - Uses both helicopters and jets as air units
        - Assault units are generally faster but less durable
        - Navy units are amphibious: can move on shores, sand and ice
